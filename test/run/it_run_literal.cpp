...
TEST_F(it_run_literal, numeric_i32_default) {
  node_t node = create_literal_numeric(ctx, _loc(), "42",
      CUBEC_LITERAL_NUMERIC_KIND_INTEGER, CUBEC_LITERAL_NUMERIC_TYPE_DEFAULT);
  value_t v = run_literal_numeric(ctx, node, false);
...
TEST_F(it_run_literal, numeric_i64) {
  node_t node = create_literal_numeric(ctx, _loc(), "9999999999",
...
TEST_F(it_run_literal, numeric_u8) {
  node_t node = create_literal_numeric(ctx, _loc(), "200",
...
TEST_F(it_run_literal, numeric_f64_default) {
  node_t node = create_literal_numeric(ctx, _loc(), "3.14",
...
TEST_F(it_run_literal, numeric_f32) {
  node_t node = create_literal_numeric(ctx, _loc(), "2.5",
...
TEST_F(it_run_literal, numeric_shadow) {
  ...
  value_t v = run_literal_numeric(ctx, node, true);
...
TEST_F(it_run_literal, string_basic) {
  node_t node = create_literal_string(ctx, _loc(), "hello");
  value_t v = run_literal_string(ctx, node, false);
...
TEST_F(it_run_literal, string_shadow) {
  node_t node = create_literal_string(ctx, _loc(), "hello");
  value_t v = run_literal_string(ctx, node, true);
...
TEST_F(it_run_literal, char_basic) {
  node_t node = create_literal_char(ctx, _loc(), 'A');
  value_t v = run_literal_char(ctx, node, false);
...
TEST_F(it_run_literal, char_shadow) {
  node_t node = create_literal_char(ctx, _loc(), 'Z');
  value_t v = run_literal_char(ctx, node, true);
...
TEST_F(it_run_literal, nil_basic) {
  node_t node = create_literal_nil(ctx, _loc());
  value_t v = run_literal_nil(ctx, node, false);
...
TEST_F(it_run_literal, nil_shadow) {
  node_t node = create_literal_nil(ctx, _loc());
  value_t v = run_literal_nil(ctx, node, true);
...
TEST_F(it_run_literal, undefined_returns_exception) {
  node_t node = create_literal_undefined(ctx, _loc());
  value_t v = run_literal_undefined(ctx, node, false);
...
TEST_F(it_run_literal, undefined_shadow_returns_exception) {
  node_t node = create_literal_undefined(ctx, _loc());
  value_t v = run_literal_undefined(ctx, node, true);
...
TEST_F(it_run_literal, identifier_found) {
  ...
  node_t node = create_literal_identifier(ctx, _loc(), "x");
  value_t v = run_literal_identifier(ctx, node, false);
...
TEST_F(it_run_literal, identifier_not_found) {
  node_t node = create_literal_identifier(ctx, _loc(), "nonexistent");
  value_t v = run_literal_identifier(ctx, node, false);
...
TEST_F(it_run_literal, identifier_shadow) {
  ...
  node_t node = create_literal_identifier(ctx, _loc(), "y");
  value_t v = run_literal_identifier(ctx, node, true);
