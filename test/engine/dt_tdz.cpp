...
class dt_tdz : public CubecTest {
protected:
  TEST_ALLOCATOR;
};

/* ===== TDZ: temporal dead zone (in test blocks) ===== */

TEST_F(dt_tdz, use_after_declaration_ok) {
...
TEST_F(dt_tdz, void_function_no_return_ok) {
  /* Void function without explicit return is fine */
  const char *src = BUILTIN_ASSERT
    "test \"void_no_return\" {\n"
    "  var x = 5;\n"
    "}\n";
