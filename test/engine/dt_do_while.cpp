...
class dt_do_while : public CubecTest {
protected:
  TEST_ALLOCATOR;
};

/* ===== do-while: parser-level only (declaration) ===== */

TEST_F(dt_do_while, do_while_decl) {
  /* do-while in test blocks currently triggers SEH crash
