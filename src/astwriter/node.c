...
cubec_any_t cubec_write_ast_node(cubec_ast_node_t self,
                                 cubec_allocator_t allocator) {
  cubec_any_t value = NULL;
  switch (self->type) {
  ...
  // cubec_any_t end =
  //     cubec_any_set_object(cubec_create_any(allocator), allocator);
  // cubec_any_set_field(begin, allocator, "line",
  //                       cubec_any_set_number(cubec_create_any(allocator),
  //                                              allocator,
  //                                              self->loc.begin.line));
  // cubec_any_set_field(begin, allocator, "column",
  //                       cubec_any_set_number(cubec_create_any(allocator),
  //                                              allocator,
  //                                              self->loc.begin.column));
  // cubec_any_set_field(end, allocator, "line",
  //                       cubec_any_set_number(cubec_create_any(allocator),
  //                                              allocator,
  //                                              self->loc.end.line));
  // cubec_any_set_field(end, allocator, "column",
  //                       cubec_any_set_number(cubec_create_any(allocator),
  //                                              allocator,
  //                                              self->loc.end.column));
  // cubec_any_set_field(location, allocator, "begin", begin);
  // cubec_any_set_field(location, allocator, "end", end);
  // cubec_any_set_field(value, allocator, "location", location);
  char *src = cubec_location_get(self->loc, allocator);
  cubec_any_t text =
      cubec_any_set_string(cubec_create_any(allocator), allocator, src);
  cubec_allocator_free(allocator, src);
  cubec_any_set_field(value, allocator, "text", text);
  return value;
}