...
class_t g_cubec_statement_return_class = {
    .name = "cubec.cubec.statement_return",
    .size = sizeof(struct _cubec_statement_return_t),
    .init = (class_init_fn_t)_cubec_statement_return_init,
    .dispose = (class_dispose_fn_t)_cubec_statement_return_dispose,
    .clone = (class_clone_fn_t)_cubec_statement_return_clone,
    .move = (class_move_fn_t)_cubec_statement_return_move,
};
...
node_t read_statement_return(context_t ctx, vec_t tokens, size_t *position,
  ...
  node = allocator_create(allocator, &g_cubec_statement_return_class, &init);
  *position = current;
  return &node->super;
