...
type_t g_cubec_expression_deref_type = {
    .name = "cubec.cubec.expression_deref",
    .size = sizeof(struct _cubec_expression_deref_t),
    .init = (type_init_fn_t)_cubec_expression_deref_init,
    .dispose = (type_dispose_fn_t)_cubec_expression_deref_dispose,
    .clone = (type_clone_fn_t)_cubec_expression_deref_clone,
    .move = (type_move_fn_t)_cubec_expression_deref_move,
};
...
node_t read_expression_deref(context_t ctx, vec_t tokens, size_t *position,
  ...
  node = allocator_create(allocator, &g_cubec_expression_deref_type,
