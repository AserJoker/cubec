#ifndef _H_CUBEC_C_IR_STMT_DO_WHILE_
#define _H_CUBEC_C_IR_STMT_DO_WHILE_
#include "c/c_ir.h"
#ifdef __cplusplus
extern "C" {
#endif

typedef struct _c_ir_stmt_do_while_t *c_ir_stmt_do_while_t;

struct _c_ir_stmt_do_while_t {
  enum c_ir_kind kind;
