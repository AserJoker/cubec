...
void cubec_hash_map_set(cubec_hash_map_t self, void *key, void *value,void *hash_arg);
void *cubec_hash_map_get(cubec_hash_map_t self, const void *key,void *hash_arg);
void cubec_hash_map_delete(cubec_hash_map_t self, const void *key,void *hash_arg);
...
void *cubec_hash_map_node_get_key(cubec_list_node_t self,cubec_hash_map_t hash_map);
void *cubec_hash_map_node_get_value(cubec_list_node_t self,cubec_hash_map_t hash_map);
void cubec_hash_map_node_set_key(cubec_list_node_t self, cubec_hash_map_t map, void *key);
