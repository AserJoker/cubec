 ...
 */
struct _cubec_expression_type_struct_t;
struct _cubec_expression_type_struct_t {
...
typedef struct _cubec_expression_type_struct_t *cubec_expression_type_struct_t;

extern type_t g_cubec_expression_type_struct_type;

struct _cubec_expression_type_struct_init_t {
  location_t location;
  node_t parent;
  vec_t generic_params;
  vec_t members;
};
typedef struct _cubec_expression_type_struct_init_t cubec_expression_type_struct_init_t;
 ...
 *
 * Parses [generic_params] { members } and returns an expression_type_struct
