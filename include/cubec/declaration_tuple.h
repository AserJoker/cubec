 ...
 */
struct _cubec_declaration_tuple_t;
struct _cubec_declaration_tuple_t {
  struct _cubec_expression_t super;
  vec_t element_types; /**< Vector of type expression nodes (auto_dispose=true) */
};
typedef struct _cubec_declaration_tuple_t *cubec_declaration_tuple_t;

extern class_t g_cubec_declaration_tuple_class;

struct _cubec_declaration_tuple_init_t {
  location_t location;
  node_t parent;
  vec_t element_types;
};
typedef struct _cubec_declaration_tuple_init_t cubec_declaration_tuple_init_t;
