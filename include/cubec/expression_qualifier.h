#ifndef _H_CUBEC_CUBEC_EXPRESSION_QUALIFIER_
#define _H_CUBEC_CUBEC_EXPRESSION_QUALIFIER_
...
struct _cubec_expression_qualifier_t;
struct _cubec_expression_qualifier_t {
...
typedef struct _cubec_expression_qualifier_t
    *cubec_expression_qualifier_t;

extern type_t g_cubec_expression_qualifier_type;

struct _cubec_expression_qualifier_init_t {
  location_t location;
  node_t parent;
  node_t type;
  bool is_const;
...
typedef struct _cubec_expression_qualifier_init_t
    cubec_expression_qualifier_init_t;
 ...
 * @return A new cubec_expression_qualifier_t node, or NULL if the current
