 ...
 * - extern: function has no body, declared for external linkage (mutually exclusive with export/inline)
 *
 ...
 *         is not a function declaration prefix (export/inline/extern/func).
 */
