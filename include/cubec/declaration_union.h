 ...
 */
struct _cubec_declaration_union_t;
struct _cubec_declaration_union_t {
...
typedef struct _cubec_declaration_union_init_t cubec_declaration_union_init_t;
 ...
 *
 * Parses [generic_params] { fields } and returns an declaration_union
