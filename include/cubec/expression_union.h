#ifndef _H_CUBEC_CUBEC_EXPRESSION_UNION_
#define _H_CUBEC_CUBEC_EXPRESSION_UNION_
 ...
 */
struct _cubec_expression_union_t;
struct _cubec_expression_union_t {
...
typedef struct _cubec_expression_union_t *cubec_expression_union_t;

extern type_t g_cubec_expression_union_type;

struct _cubec_expression_union_init_t {
  location_t location;
  node_t parent;
  vec_t generic_params;
  vec_t members;
};
typedef struct _cubec_expression_union_init_t cubec_expression_union_init_t;
 ...
 * @return A new cubec_expression_union_t node, or NULL if current token
 *         is not 'union' keyword.
 */
node_t read_expression_union(context_t ctx, vec_t tokens,
                                   size_t *position, const char *filename);

/**
 * @brief Parse union body after 'union' keyword has been consumed.
 *
 * Parses [generic_params] { fields } and returns an expression_union
 ...
 * @return A new cubec_expression_union_t node, or NULL on error.
 */
