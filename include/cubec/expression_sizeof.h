...
extern class_t g_cubec_expression_sizeof_class;
 ...
 */
node_t read_expression_sizeof(vm_t vm, vec_t tokens, size_t *position,
                              const char *filename);

node_t create_expression_sizeof(vm_t vm, location_t loc, node_t expr);
