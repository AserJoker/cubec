...
struct _cubec_expression_function_t {
  ...
  node_t name;    /**< Identifier node for named function (nullable, NULL for
                     anonymous) */
  ...
  node_t body; /**< Block statement node (nullable for interface-style named
                  funcs) */
...
typedef struct _cubec_expression_function_init_t
    cubec_expression_function_init_t;
